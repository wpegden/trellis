...
//!   TRELLIS_VERIFY_STATE_PATH  default: /path/to/trellis/math/example-run-runtime/protocol_state.json
...
fn shallow_coarse_cross_check_on_live_snapshot() {
    let state_path = std::env::var("TRELLIS_VERIFY_STATE_PATH")
        .unwrap_or_else(|_| "/path/to/trellis/math/example-run-runtime/protocol_state.json".into());
