...
mod tests {
    ...
    fn sample_request(kind: RequestKind) -> WrapperRequest {
        WrapperRequest {
            ...
            trust_conditional_theorem_candidates: BTreeMap::new(),
            trust_dormant_conditional_candidate_nodes: BTreeSet::new(),
            trust_source_validation_guidance: BTreeMap::new(),
            pv_goal_mode: crate::model::PvGoalMode::Spec,
