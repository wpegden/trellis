...
pub mod runtime_cli_observations_halt {
    pub use crate::runtime_cli_observations::{
        ...
        system_feedback_log_path, write_system_feedback_halt_marker, HaltMarkerAckOutcome,
        SystemFeedbackAck, SystemFeedbackAckResult, SystemFeedbackAckStore,
        CHECKER_DISAGREEMENT_HALT_MARKER_FILENAME, SYSTEM_FEEDBACK_ACK_STORE_FILENAME,
        SYSTEM_FEEDBACK_HALT_ENV, SYSTEM_FEEDBACK_HALT_MARKER_FILENAME,
        SYSTEM_FEEDBACK_LOG_FILENAME,
    };
}
pub mod tablet_root;
