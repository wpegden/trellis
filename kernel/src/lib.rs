...
pub mod runtime_cli_observations_halt {
    pub use crate::runtime_cli_observations::{
        ...
        system_feedback_design_gap_log_path, system_feedback_fingerprint,
        system_feedback_halt_marker_path, system_feedback_halt_marker_present,
        write_system_feedback_halt_marker, HaltMarkerAckOutcome, SystemFeedbackAck,
        SystemFeedbackAckResult, SystemFeedbackAckStore,
        CHECKER_DISAGREEMENT_HALT_MARKER_FILENAME, SYSTEM_FEEDBACK_ACK_STORE_FILENAME,
        SYSTEM_FEEDBACK_DESIGN_GAP_LOG_FILENAME, SYSTEM_FEEDBACK_HALT_MARKER_FILENAME,
    };
}
pub mod tablet_root;
