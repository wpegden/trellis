...
ReviewContinue ==
    ...
    /\ \E nextMode \in WorkerModes,
        ...
        /\ \* Sidecar queue mutations (queue redesign): adds are new
           \* members; the CANCEL-BEFORE-WORKER owner rule forbids
           \* routing the worker at a node still queued after this
           \* response's own mutations (Q' formulation).
           queueAdd \cap sidecarQueue = {}
        /\ newActive \notin (sidecarQueue \cup queueAdd) \ queueRemove
        /\ sidecarQueue' = (sidecarQueue \ queueRemove) \cup queueAdd
