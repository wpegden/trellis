...
the phase window open (ProofFormalization unconditionally;
`theorem_stating` — which also models RevisionStating, cf. §22 — iff
every configured target is covered). Effect: the node closes, its
