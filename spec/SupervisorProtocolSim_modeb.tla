------------------------------ MODULE SupervisorProtocolSim_modeb ------------------------------
...
SimInitialConfiguredTargets == {}  \* mode-B: no paper-faithfulness bucket
...
SimGoalMode == "lean"  \* mode-B (Lean-goals / byte-pinned challenge specs)
