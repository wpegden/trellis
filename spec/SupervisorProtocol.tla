...
WorkerAcceptedResponsesSatisfyContract ==
    ...
    \/ /\ WorkerStructuralMapsMatchObserved
       ...
       /\ (WorkerCleanupValidation \/ WorkerRemovedNodes = WorkerSameBurstOrphansBeforeDeletion)
       /\ WorkerPostResponseOrphans = {}
...
RequestRecord(reqId, kind) ==
    [
        ...
        projectInvariants |-> ProjectInvariants,
        freshContext |-> RequestFreshContext(kind),
                    promptContractVersion |-> IF kind = "none" THEN 0 ELSE 40,
...
TypeOK ==
    ...
    \* guard, etc.); current value 35.
    /\ inFlightRequest.promptContractVersion \in 0..40
    /\ inFlightRequest.promptContractVersion =
        IF inFlightRequest.kind = "none" THEN 0 ELSE 40
