...
DEFAULT_WORKER_MODEL_AB_A_MODEL = "gpt-5.4"
DEFAULT_WORKER_MODEL_AB_B_MODEL = "gpt-5.5"
...
def _maybe_malformed_verifier_response(
    *,
    ...
    """Bug 1 (designs incident 2026-06-26): a verifier panel member that
...
def _handle_worker(
    *,
    ...
    cached_response = _cached_worker_response_for_request(runtime_root, request)
