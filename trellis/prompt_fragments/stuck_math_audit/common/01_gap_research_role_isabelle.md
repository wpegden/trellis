...
stated via this counterexample, and necessary in its current form for Theorem Y
...
You propose; the worker writes. Use an Isabelle scratchpad to sanity-check the
