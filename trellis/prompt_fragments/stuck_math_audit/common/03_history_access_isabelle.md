...
rg <pattern> Tablet/*.thy
git --no-optional-locks log -- Tablet/<Node>.thy
git --no-optional-locks show <rev>:Tablet/<Node>.thy
git --no-optional-locks diff <rev1> <rev2> -- Tablet/<Node>.thy
```
