...
This is a fresh run: the Tablet contains only the bootstrap Preamble, and no worker has run yet. You are the run's initial planner, dispatched once at cycle 1 to chart how formalization should unfold.
