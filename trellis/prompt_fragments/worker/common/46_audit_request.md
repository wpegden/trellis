...
- `reason`: a concise statement of the problem, at most 1000 characters; for `suspect_report` name the report or plan and the locus (node / task / paper reference) to re-examine.
