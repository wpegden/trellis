...
class ProviderConfig:
    ...
    # Any string the provider CLI accepts (claude: low/medium/high/max).
    # Known tiers are registered in trellis.config.KNOWN_EFFORTS (advisory;
    # not imported here — config imports this module).
